  ...
  return (
    <footer className="bg-white border-t border-gray-100 mt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-twitter-dark">TweetBlog</h3>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-twitter-dark mb-4">Features</h4>
            <ul className="space-y-2 text-twitter-gray">
          ...
          <div>
            <h4 className="font-semibold text-twitter-dark mb-4">Support</h4>
            <ul className="space-y-2 text-twitter-gray">
              <li>
                <a href="#" className="hover:text-twitter-blue transition-colors">
                  Documentation
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-100 mt-8 pt-8 text-center text-twitter-gray">
